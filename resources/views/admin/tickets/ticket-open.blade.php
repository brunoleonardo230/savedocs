...
<!-- <div class="container-fluid"> -->
    ...
    <div class="card shadow mb-4">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a href="#aberto" class="nav-link" data-toggle="tab">ABERTO</a>
            </li>
            <li class="nav-item">
                <a href="#em-andamento" class="nav-link" data-toggle="tab">EM ANDAMENTO</a>
            </li>
        </ul>

        <div class="tab-content">
            <div class="tab-pane active in" id="aberto">
                <div class="card-body">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Alterar Status - {{$ticket->ticket_code}}</h5>
            ...
            <div class="tab-pane" id="em-andamento">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered data-table" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                            ...
                            <tbody>
                            @forelse($ticketsinprogress as $key => $ticket)
                                <tr class="text-center">
                                    <td> {{$ticket->id}} </td>
                                    <td> {{$ticket->ticket_code}} </td>
                                    <td>
