            ...
            <form action="{{route('equipaments.store')}}"  method="post">
                ...
                <div class="row form-group">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Ex.: Administrativo" required>
                ...
                <div class="row form-group">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('identification_code') is-invalid @enderror" name="identification_code" placeholder="Ex.: 34-FF-8F-FA-9E-70" required>
